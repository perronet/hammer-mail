...
Each request has to contain an authentication, with is a valid username and password. Use:
...
### Responses
A response is _always_ sent from server to client. Each response is an object derived from ResponseBase. Use:
